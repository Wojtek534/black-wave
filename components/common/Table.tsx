      ...
      <table className="w-full">
        <thead>
          {table.getHeaderGroups().map((headerGroup) => (
            <tr key={headerGroup.id} className="border-b mb-1 text-left capitalize ">
              {headerGroup.headers.map((header) => (
                <th key={header.id} className="px-2 py-1">
                  <div className="flex items-center">
                    ...
                    {/* Sorting */}
                    {{
                      asc: <Icon icon={IconList.CHEVRON_UP} space={Space.VerySmall} />,
                      desc: <Icon icon={IconList.CHEVRON_DOWN} space={Space.VerySmall} />,
